...
<nav class="navbar navbar-expand-lg bg-white border-bottom sticky-top shop-navbar">
    <div class="container">
        ...
        <button class="navbar-toggler py-1 px-2" type="button" data-bs-toggle="collapse" data-bs-target="#shopNav" aria-controls="shopNav" aria-expanded="false" aria-label="Mở menu">
