...
<div class="container-fluid px-2 px-md-4 mb-5">
    ...
    <div class="card border-0 shadow-sm rounded-4">
        <div class="card-body p-4 p-md-5 text-center">
            ...
            <h5 class="fw-bold text-dark mb-2">Dữ liệu nhập xuất tồn chưa được khởi tạo</h5>
            <p class="text-muted mb-4">Vui lòng chạy migration và backfill dữ liệu trước khi xem báo cáo này.</p>
            <div class="bg-light border rounded-3 p-3 text-start d-inline-block">
                <code>php artisan migrate</code><br>
                <code>php artisan stock:backfill-movements</code>
            </div>
        </div>
    </div>
</div>
