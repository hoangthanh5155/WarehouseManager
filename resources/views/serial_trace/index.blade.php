...
<div class="container-fluid px-2 px-md-4 mb-5">
    ...
    @if($product)
        <div class="row g-2 g-md-3 mb-3">
            ...
            <div class="col-6 col-lg-3"><div class="bg-white shadow-sm rounded-4 p-3 h-100"><div class="text-muted small fw-bold">San pham</div><div class="fw-bold text-dark">{{ $product->productCatalog?->product_name ?: 'N/A' }}</div></div></div>
