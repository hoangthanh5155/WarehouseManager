...
<div class="container-fluid px-2 px-md-4 mb-5">
    <div class="bg-white border-0 shadow-sm rounded-4 p-3 p-md-4 mb-4 mt-2">
        ...
        <h4 class="fw-bold text-dark m-0">Thêm nhà cung cấp</h4>
        <div class="text-muted small">Tạo nhà cung cấp dùng trong nhập kho và danh mục sản phẩm</div>
    </div>
        ...
        <div class="card-body p-3 p-md-4">
            <form action="{{ route('suppliers.store') }}" method="POST">
                ...
                <button type="submit" class="btn btn-primary fw-bold">
                    <i class="bi bi-save me-1"></i>Lưu nhà cung cấp
                </button>
            </form>
        </div>
    </div>
