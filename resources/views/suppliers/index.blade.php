    ...
    <div class="master-page-header d-flex flex-column flex-md-row justify-content-between gap-3 mb-4 mt-2">
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                ...
                <h4 class="fw-bold text-dark m-0">Nhà cung cấp</h4>
                <div class="text-muted small">Quản lý danh sách nhà cung cấp dùng trong nhập kho</div>
            </div>
        </div>
        <a href="{{ route('suppliers.create') }}" class="btn btn-primary fw-bold rounded-3 align-self-start align-self-md-center">
                        ...
                        <tr>
                            ...
                            <td class="text-end pe-3">
                                <div class="d-flex gap-2 justify-content-end">
                                    <a href="{{ route('suppliers.edit', $s->id) }}" class="btn btn-sm btn-outline-primary fw-bold">
